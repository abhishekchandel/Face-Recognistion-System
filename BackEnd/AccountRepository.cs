    ...
    public class AccountRepository : IAccountRepository
    {
            ...
            try
            {
                ...
                if (ageVerificationResponse.Success == true)
                {
                    ...
                    if (!string.IsNullOrEmpty(APIContent.actionMessage) && APIContent.actionMessage == "Created With Success")
                    {
                        using (AppDBEntities db = new AppDBEntities())
                        {
                            var UpdateUser = db.system_user.Where(x => x.email == accountDetail.Email).FirstOrDefault<system_user>();
                            ...
                            if (paymentDetailsRequest.PaymentDetails != null)
                            {
                                ...
                                if (paymentDetailsRequest.PaymentDetails.PaymentMethod == "Amazon")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        savePaymentReposne.AmazonParamters = App.Repository.Repository.AccountRepository.AddRequiredParameters(paymentDetailsRequest.PaymentDetails.TotalOrder.ToString(), ApplicationConfiguration.DEFAULT_CURRENCY, sellerNote, payment.PaymentId, true);
                                    }
                                }
                            }
                            else
        ...
        public async Task<SignUpReposne> SignUpUser(SignUpDetailsRequest signUpDetails)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(APIContent.actionMessage) && APIContent.actionMessage == "Created With Success")
                {
                    using (AppDBEntities dbLocalObj = new AppDBEntities())
                    {
                        ...
                        if (signUpDetails.LinksDetails.Length > 0)
                        {
                            ...
                            {
                                App.Repository.DMCARemovalLink DMCARemovalLink = new App.Repository.DMCARemovalLink();
                        ...
                        var templateResponse = await dbLocalObj.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"fn_getSignUpTemplate\"('" + TemplateName + "', '" + user.UserDetail.Email + "', '" + user.UserDetail.Password + "') AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='" + TemplateName + "'").FirstOrDefaultAsync();
                    ...
                    if (!string.IsNullOrEmpty(loggedInUser))
                    {
                        ...
                        if (systemUser.id > 0)
                        {
                            ...
                            if (userBiometeric != null && userBiometeric.id > 0)
                            {
                                ...
                                //                var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"FN_FaceSearchTemplate\"('SEARCH_SUCCESS'," + reconizeFaceByUserBiometericsResponse.candidateFaceList.Count + ") AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='SEARCH_SUCCESS'").FirstOrDefaultAsync();
                                //                mailContent.MsgSubject = templateResponse.Subject;
                                //                mailContent.MsgBody = templateResponse.Template;
                                //            }
                                //            else
                                ...
                                //                var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"FN_FaceSearchTemplate\"('SEARCH_FAILURE',0) AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='SEARCH_FAILURE'").FirstOrDefaultAsync();
                                //                mailContent.MsgSubject = templateResponse.Subject;
                                //                mailContent.MsgBody = templateResponse.Template;
                                ...
                                profileDetailResponse.PackageFeatureDetail = await (from UD in db.UserDetails
                                                                                    ...
                                                                                    select new PackageFeatureDetail
                                                                                    {
                                                                                        ...
                                                                                        packagefeature = (from PF in db.PackageFeatures
                                                                                                          ...
                                                                                                          select new App.Entities.Response.PackageFeature
                                                                                                          {
                            ...
                            if (paymentDetailsRequest.PaymentDetails != null)
                            {
                                ...
                                if (paymentDetailsRequest.PaymentDetails.PaymentMethod == "Amazon")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        savePaymentReposne.AmazonParamters = App.Repository.Repository.AccountRepository.AddRequiredParameters(paymentDetailsRequest.PaymentDetails.TotalOrder.ToString(), ApplicationConfiguration.DEFAULT_CURRENCY, sellerNote, payment.PaymentId, false);
                                    }
                                }
                                savePaymentReposne.PaymentId = payment.PaymentId;
                            }
                    ...
                    using (AppDBEntities db = new AppDBEntities())
                    {
                        ...
                        if (userId > 0)
                        {
                            DMCALinksResponse.DMCALinks = await db.DMCARemovalLinks.Where(x => x.UserId == userId && x.LegalAction != null)
                                .Select(x => new App.Entities.Response.DMCALink
                                {
                                    UserId = x.UserId,
                                    Url = x.Url,
        ...
        public async Task<BaseResponse> EmailDMCANotice(DMCANoticeEmailRequest DMCANoticeEmailRequest)
        {
            try
            {
                ...
                using (AppDBEntities db = new AppDBEntities())
                {
                    ...
                    if (!string.IsNullOrEmpty(loggedInUser))
                    {
                        var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"fn_getdmcanotice\"('" + loggedInUser + "', '" + DMCANoticeEmailRequest.siteName + "', 'DMCA Notice') AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='DMCA Notice'").FirstOrDefaultAsync();
                        mailContent = new MailContent();
        ...
        public async Task<BaseResponse> EmailLawyerLetter(LawyerLetterEmailRequest lawyerLetterEmailRequest)
        {
            try
            {
                ...
                using (AppDBEntities db = new AppDBEntities())
                {
                    ...
                    if (!string.IsNullOrEmpty(loggedInUser))
                    {
                        var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"fn_getLawyerLetter\"('Lawyer Letter Removal Second Attempt', '" + loggedInUser + "', '" + lawyerLetterEmailRequest.siteName + "') AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='Lawyer Letter Removal Second Attempt'").FirstOrDefaultAsync();
                        mailContent = new MailContent();
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(loggedInUser))
                {
                    using (AppDBEntities db = new AppDBEntities())
                    {
                        ...
                        if (userId > 0)
                        {
                            App.Repository.LegalEnquiry legalEnquiry = new App.Repository.LegalEnquiry();
                            ...
                            // Email sent to user
                            var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='User_Enquiry'").FirstOrDefaultAsync();
                            mailContent = new MailContent();
                            mailContent.ToEmail = loggedInUser;
                            mailContent.MsgSubject = templateResponse.Subject;
                            mailContent.MsgBody = templateResponse.Template;
                            ...
                            // Email sent to FPP
                            templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"FN_GetEnqTick\"('FPP_Enquiry','" + loggedInUser + "','" + enquiryRequest.Message + "') AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='FPP_Enquiry'").FirstOrDefaultAsync();
        ...
        public async Task<Stream> DownloadInvoice(int InvoiceId)
        {
            ...
            try
            {
                ...
                using (AppDBEntities db = new AppDBEntities())
                {
                    ...
                    if (userId > 0)
                    {
                        var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"FN_Get_Invoice\"('Invoices', " + InvoiceId + ",'" + loggedInUser + "') AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='Invoices'").FirstOrDefaultAsync();
                        var LogoPath = HttpContext.Current.Server.MapPath("~/Uploads/Logo/fpp_logo.jpg");
                        var Stamp = HttpContext.Current.Server.MapPath("~/Uploads/Logo/App_stamp.png");
                        ...
                        if (userId > 0)
                        {
                            ...
                            if (SitesJson != null)
                            {
                                ...
                                foreach (var row in SiteResults)
                                {
                                    ...
                                    var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"FN_getDMCAnotice\"( " + userId + ",'" + DMCAnoticeGenerateRequest.FirstName + " " + DMCAnoticeGenerateRequest.LastName + "','" + DMCAnoticeGenerateRequest.Email + "'," + row.SiteId + ",'" + row.SiteName + "','" + row.WebsiteAddress + "','DMCA Notice') AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='DMCA Notice'").FirstOrDefaultAsync();
                                    ...
                                    templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"fn_getsecondattempt\"( " + userId + ",'" + DMCAnoticeGenerateRequest.FirstName + " " + DMCAnoticeGenerateRequest.LastName + "','" + DMCAnoticeGenerateRequest.Email + "', 'Lawyer Letter Removal Second Attempt'," + row.SiteId + ") AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='Lawyer Letter Removal Second Attempt'").FirstOrDefaultAsync();
            ...
            try
            {
                ...
                using (AppDBEntities db = new AppDBEntities())
                {
                    ...
                    if (result != null)
                    {
                        ...
                        var templateResponse = await db.Database.SqlQuery<App.Entities.Response.TemplateDetail>("SELECT \"TemplateId\", \"TemplateName\", \"Subject\", \"public\".\"fn_getSignUpTemplate\"('" + TemplateName + "', '" + system_user.email + "', '" + Password + "') AS \"Template\", \"Active\" from \"public\".\"EmailTemplates\" where \"TemplateName\"='" + TemplateName + "'").FirstOrDefaultAsync();
        ...
        {
            string url = "https://graph.facebook.com/App/posts?fields=full_picture%2Cpicture%2Clink%2Cmessage%2Ccreated_time%2Cpermalink_url%2Cdescription&limit=" + limit + "&access_token=" + accessToken;
            if (after != null)
            {
                url += "&after=" + after;
            }
